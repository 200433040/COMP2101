...
[ "`whoami`" = "root" ] && echo "Not to be run as root" && exit
...
test -d public_html/pics || mkdir -p ~/public_html/pics ; wget -q -O ~/public_html/pics/pics.zip http://zonzorp.net/pics.zip && unzip -d ~/public_html/pics -o -q ~/public_html/pics/pics.zip && rm ~/public_html/pics/pics.zip && rm -rf ~/public_html/pics/pics.zip
